...
<form 
    ...
    <input type="email"
        ...
        class="bg-transparent font-lg font-bold tracking-wide uppercase placeholder:text-alternative-black border-b-[1px] border-alternative-black outline-none w-56"
    />
